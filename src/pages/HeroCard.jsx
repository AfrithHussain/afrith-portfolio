...
<div className="flex flex-col-reverse lg:flex-row justify-evenly items-center w-screen">
  <div className="text-center md:text-left mt-44">
    <div className="flex items-center gap-4 translate-x-14 md:translate-x-0 md:mx-[0px] justify-center  w-fit ">
      <h1 className="text-[22px] md:text-5xl lg:text-5xl font-black">Hey, I am </h1>
