...
<div className="flex flex-col-reverse lg:flex-row justify-evenly items-center w-screen">
  <div className="text-center md:text-left mt-44">
    <div className="flex items-center gap-4  justify-center lg:w-fit ">
      <h1 className="text-2xl md:text-5xl lg:text-5xl font-black">Hey, I am </h1>
      <WordRotate className="text-2xl  md:text-5xl lg:text-5xl font-bold text-black dark:text-white" words={["Afrith Hussain", "Frontend Developer"]} />
    </div>
